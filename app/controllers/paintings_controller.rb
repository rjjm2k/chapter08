class PaintingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @painting.save
        ...
        format.json { render json: @painting.gallery, status: :created, location: @painting }  #not sure,maybe have to change @painting to @painting.gallery
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @painting.gallery, notice: 'Painting successfully deleted.' }
      format.json { head :no_content }
    end
  end
end
